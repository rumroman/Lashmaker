...
module.exports = function(Chart) {
	...
	/**
	 * Initializes the given app.config with global and chart default values.
	 */
	...
	/**
	 * Updates the app.config of the chart
	...
	helpers.extend(Chart.prototype, /** @lends Chart */ {
		...
		construct: function(item, config) {
			 ...
			 */
			me.chart = me;
			me.controller = me; // chart.chart.app.controller #inception

			// Add the chart instance to the global namespace
			Chart.instances[me.id] = me;

			// Define alias to the app.config data: `chart.data === chart.app.config.data`
			...
			if (!context || !canvas) {
				...
				// the chart initialization but after setting basic chart / app.controller properties that
	...
	helpers.configMerge = function(/* objects ... */) {
		return helpers.merge(helpers.clone(arguments[0]), [].slice.call(arguments, 1), {
			merger: function(key, target, source, options) {
				...
				if (key === 'scales') {
					// scale app.config merging is complex. Add our own function here for that
 ...
 * since responsiveness is handled by the app.controller.resize() method. The app.config is used
...
defaults._set('global', {
	legend: {
		...
		onClick: function(e, legendItem) {
			...
			// See app.controller.isDatasetVisible comment
...
module.exports = function(Chart) {
	...
	// Default app.config for a category scale
	var defaultConfig = {
		position: 'bottom'
	};
